                ...
                <div class="modal-body p-4">
                    ...
                    <div class="p-3 rounded-4 mb-4" style="background: #eef6ff; border: 1px solid #cfe2ff;">
                        ...
                        <div class="mb-0">
                            ...
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-white  shadow-sm"><i class="bi bi-geo-alt-fill text-danger"></i></span>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <select name="vehiculo_id" id="v_vehiculo_id" class="form-select  bg-light p-3 rounded-3 shadow-sm" required>
                        ...
                        <div class="col-12">
                            ...
                            <select name="chofer_id" id="v_chofer_id" class="form-select  bg-light p-3 rounded-3 shadow-sm" required>
                        ...
                        <div class="col-12">
                            ...
                            <select name="tripulantes[]" id="v_tripulantes" class="form-select  bg-light p-2 rounded-3 shadow-sm" style="font-size: 0.85rem;" multiple size="3">
                            </select>
